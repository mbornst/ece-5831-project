...
class TrafficSigns:
    ...
    def _load_training(self):
        ...
        for i in range(42 + 1):
            ...
            for entry in obj:
                if entry.is_file() and (".ppm" in entry.name) and not(("CW.ppm" in entry.name) or ("CCW.ppm" in entry.name)):
                    #print(entry.name)
...
#%%
with open("traffic_signs_GaC_SunnyCloudy_NN", 'wb') as f:
    pickle.dump(history, f, -1)
    
with open("traffic_signs_GaC_SunnyCloudy_NN", 'rb') as f:
